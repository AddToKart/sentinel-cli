...
export const AVAILABLE_MODELS = [
  ...
  new Separator(chalk.magenta('--- OpenAI ---')),
  { name: chalk.bold('GPT-4o'), value: { provider: 'openai', model: 'gpt-4o' } },
  { name: chalk.bold('GPT-4.5'), value: { provider: 'openai', model: 'gpt-4.5' } },
  { name: chalk.bold('GPT-4o Mini'), value: { provider: 'openai', model: 'gpt-4o-mini' } },
  new Separator(chalk.yellow('--- Anthropic ---')),
  { name: chalk.bold('Claude 3.5 Sonnet'), value: { provider: 'anthropic', model: 'claude-3-5-sonnet-latest' } },
  { name: chalk.bold('Claude 3.5 Haiku'), value: { provider: 'anthropic', model: 'claude-3-5-haiku-latest' } },
  { name: chalk.bold('Claude 3 Opus'), value: { provider: 'anthropic', model: 'claude-3-opus-latest' } },
